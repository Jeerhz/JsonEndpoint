...
url = "https://graph.microsoft.com/v1.0/sites/1b04792a-89a2-4d7e-905f-b6e907d37b65,29238cfc-18d8-4d0b-81e7-2cd5dc8894c7/drive/root:/Pilotage%20-%20Direction%20IT/Formatted_V4.json:/content/"
...
def get_json():
    ...
    try:
        ...
        data = response.json()
        # Transformez les données si nécessaire pour le plugin Infinity
        return jsonify(data)
